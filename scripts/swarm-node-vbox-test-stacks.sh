...
docker-machine ssh manager1 "sudo pip install --upgrade pip wheel setuptools"
# install docker-compose
docker-machine ssh manager1 "pip install docker-compose"
...
docker-machine ssh manager1 "sed -i 's/MINIO_NUM_MINIOS=1/MINIO_NUM_MINIOS=4/g' .env"
# deploy stack
docker-machine ssh manager1 "cd service/minio; make up"
docker-machine ssh manager1 "docker stack ls"

# logging stack
docker-machine ssh manager1 "cd service/graylog; make up"
docker-machine ssh manager1 "docker stack ls"
...
# deployer stack
echo "======> Deploying monitoring stack ..."
docker-machine ssh manager1 "cd service/deployment-agent; make up"
docker-machine ssh manager1 "docker stack ls"
