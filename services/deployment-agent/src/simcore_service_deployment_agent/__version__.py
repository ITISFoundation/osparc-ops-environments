...
Pre-release and development versions are denoted appending a hyphen, i.e. __version__=='0.7.0'-dev

Build metadata (e.g. git commit id, build id, ...) can be appended with a plus, i.e. __version__=='0.7.0'-dev+asd21ff
...
try:
    ...
    assert __version__=="__version__=='0.7.0'", "Did you install this package?"
